...
void main() {
  ...
  test('simple tile position', () {
    ...
    expect(result[0], TilePositionMatcher(TilePosition(2, 2, 0, 0)));
    expect(result[1], TilePositionMatcher(TilePosition(1, 0, 0, 1)));
    expect(result[2], TilePositionMatcher(TilePosition(2, 3, 1, 1)));
  });
}
